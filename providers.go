...
var providers = provider{
	"aws": {
		...
		regions: []*region{
			...
			{name: "ap-east-2", location: "Taipei, TW"},
			...
			{name: "ap-southeast-6", location: "Auckland, NZ"},
			...
			{name: "mx-central-1", location: "Central Mexico, MX"},
	...
	"alibaba": {
		...
		regions: []*region{
			...
			{name: "na-south-1", location: "Mexico City, MX"},
	...
	"azure": {
		...
		regions: []*region{
			...
			{name: "chilecentral", location: "Santiago, CL"},
			...
			{name: "indonesiacentral", location: "Jakarta, ID"},
			{name: "israelcentral", location: "Israel, IL"},
			{name: "italynorth", location: "Milan, IT"},
			{name: "japaneast", location: "Tokyo, JP"},
			{name: "japanwest", location: "Osaka, JP"},
			{name: "koreacentral", location: "Seoul, KR"},
			{name: "malaysiawest", location: "Kuala Lumpur, MY"},
			{name: "mexicocentral", location: "Queretaro, MX"},
			{name: "newzealandnorth", location: "Auckland, NZ"},
			...
			{name: "spaincentral", location: "Madrid, ES"},
			...
			{name: "westus3", location: "Phoenix, US"},
		},
	},
	"baidu": {
		name:         "Baidu Cloud",
	...
	"gcp": {
		...
		regions: []*region{
			{name: "africa-south1", location: "Johannesburg, ZA", endpoint: "https://africa-south1-5tkroniexa-bq.a.run.app/api/ping"},
			...
			{name: "europe-north2", location: "Stockholm, SE", endpoint: "https://europe-north2-5tkroniexa-ma.a.run.app/api/ping"},
			...
			{name: "europe-west10", location: "Berlin, DE", endpoint: "https://europe-west10-5tkroniexa-oe.a.run.app/api/ping"},
	...
	"huawei": {
		...
		regions: []*region{
			...
			{name: "ap-southeast-5", location: "Manila, PH"},
			{name: "cn-east-2", location: "Shanghai, CN"},
			{name: "cn-east-3", location: "Shanghai, CN"},
			{name: "cn-east-4", location: "Qingdao, CN"},
			{name: "cn-east-5", location: "Wuhu, CN"},
			{name: "cn-north-1", location: "Beijing, CN"},
			{name: "cn-north-2", location: "Beijing, CN"},
			{name: "cn-north-4", location: "Beijing, CN"},
			{name: "cn-north-9", location: "Ulanqab, CN"},
			{name: "cn-south-1", location: "Guangzhou, CN"},
			{name: "cn-south-2", location: "Shenzhen, CN"},
			{name: "cn-south-4", location: "Guangzhou, CN"},
			{name: "cn-southwest-2", location: "Guiyang, CN"},
	...
	"linode": {
		...
		regions: []*region{
			...
			{name: "au-mel", location: "Melbourne, AU", endpoint: "au-mel.speedtest.linode.com"},
			{name: "br-gru", code: "sao-paulo", location: "Sao Paulo, BR"},
			{name: "ca-central", code: "toronto1", location: "Toronto, CA"},
			{name: "es-mad", code: "madrid", location: "Madrid, ES"},
			...
			{name: "id-cgk", code: "jakarta", location: "Jakarta, ID"},
			{name: "in-maa", code: "chennai", location: "Chennai, IN"},
			{name: "it-mil", code: "milan", location: "Milan, IT"},
			{name: "jp-osa", code: "osaka", location: "Osaka, JP"},
			{name: "nl-ams", code: "amsterdam", location: "Amsterdam, NL"},
			...
			{name: "us-lax", code: "los-angeles", location: "Los Angeles, US"},
			{name: "us-mia", code: "miami", location: "Miami, US"},
	...
	"oracle": {
		...
		regions: []*region{
			...
			{name: "ap-batam-1", location: "Batam, ID"},
			{name: "ap-chuncheon-1", location: "Chuncheon, KR"},
			{name: "ap-delhi-1", location: "Delhi, IN"},
			{name: "ap-hyderabad-1", location: "Hyderabad, IN"},
			{name: "ap-kulai-2", location: "Kulai, MY"},
			...
			{name: "ap-singapore-2", location: "Singapore, SG"},
			...
			{name: "eu-madrid-3", location: "Madrid, ES"},
			...
			{name: "eu-turin-1", location: "Turin, IT"},
			...
			{name: "us-saltlake-2", location: "Salt Lake City, US"},
	...
	"qiniu": {
		...
		regions: []*region{
			...
			{name: "ap-southeast-2", location: "Hanoi, VN"},
			{name: "ap-southeast-3", location: "Ho Chi Minh City, VN"},
	...
	"servers": {
		...
		regions: []*region{
			...
			{name: "ams6", location: "Amsterdam, NL"},
			{name: "ams7", location: "Amsterdam, NL"},
			{name: "dfw1", location: "Dallas, US"},
			{name: "dfw2", location: "Dallas, US"},
			{name: "dfw3", location: "Dallas, US"},
			{name: "dfw4", location: "Dallas, US"},
			{name: "dfw5", location: "Dallas, US"},
			{name: "fra1", location: "Frankfurt, DE"},
			{name: "hkg1", location: "Hong Kong, CN"},
			{name: "lon1", location: "Slough, UK"},
			{name: "lux1", location: "Roost, LU"},
			{name: "lux2", location: "Roost, LU"},
			{name: "mia1", location: "Miami, US"},
			{name: "sao1", location: "Sao Paulo, BR"},
			{name: "sin1", location: "Singapore, SG"},
			{name: "sin2", location: "Singapore, SG"},
			{name: "sjc1", location: "San Jose, US"},
			{name: "sjc2", location: "San Jose, US"},
			{name: "sjc3", location: "San Jose, US"},
			{name: "was1", location: "Washington, US"},
			{name: "was2", location: "Washington, US"},
			{name: "was3", location: "Washington, US"},
			{name: "was4", location: "Washington, US"},
		},
	},
	"tencent": {
		name:         "Tencent Cloud",
